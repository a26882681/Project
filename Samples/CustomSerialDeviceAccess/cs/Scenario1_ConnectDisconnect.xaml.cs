...
namespace CustomSerialDeviceAccess
{
    ...
    public sealed partial class Scenario1_ConnectDisconnect : Page
    {
        ...
        private async void Write()
        {
            ...
            dataWriter.WriteString(WriteInputValue.Text);
            Debug.WriteLine(serialDevice.OutputStream);
            await dataWriter.StoreAsync();
            dataWriter.DetachStream();
            dataWriter = null;
        }
        public async void ConnectToSerialPort()
        {
        ...
        private void ConnectToDevice_Click(Object sender, RoutedEventArgs eventArgs)
        {
            Write();
        }
